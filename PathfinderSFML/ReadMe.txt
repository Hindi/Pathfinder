========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet PathfinderSFML
========================================================================

AppWizard a créé cette application PathfinderSFML pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application PathfinderSFML.


PathfinderSFML.vcxproj
...
PathfinderSFML.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé PathfinderSFML.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
