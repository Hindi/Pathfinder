========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet pathFinder
========================================================================

AppWizard a créé cette application pathFinder pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application pathFinder.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé pathFinder.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
